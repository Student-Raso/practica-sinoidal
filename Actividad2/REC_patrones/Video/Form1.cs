...
namespace Video
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Bitmap b = new Bitmap(textBox4.Text + ".png");
                pictureBox2.Image = b;
                pictureBox2.Refresh();
            }
            for (int r = 0; r < 480; r++)
            {
                for (int c = 0; c < 640; c++)
                {
                    ...
                    pr = ((pictureBox2.Image as Bitmap).GetPixel(c, r)).R;
                    pg = ((pictureBox2.Image as Bitmap).GetPixel(c, r)).G;
                    pb = ((pictureBox2.Image as Bitmap).GetPixel(c, r)).B;
                    k = Color.FromArgb(pr, pb, pg);
                    p = new Pen(k, 1);
                    if (pr < 250 && pg < 250 && pb < 250)
                    {
                        g.DrawRectangle(p, c, r, 1, 1);
                    }
                }
            }
        }
